...
#     try:
#         default_input = get_latest_labeled_file() or f'/mnt/d/python/MLOps/clone/MLOPS/data/labeled/labeled_twitter_{timestamp}.csv'
#     except Exception as e:
#         default_input = f'/mnt/d/python/MLOps/clone/MLOPS/data/labeled/labeled_twitter_{timestamp}.csv'
